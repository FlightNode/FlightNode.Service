...
namespace FlightNode.DataCollection.Domain.Migrations
{
    ...
    public partial class SurveyExportAfterNewColumnsAdded : DbMigration
    {
        public override void Up()
        {
            this.AlterStoredProcedure("dbo.ExportRookeryCensusResults", @"
BEGIN
...
END");
            this.AlterStoredProcedure("dbo.ExportForagingSurveyResults", @"
BEGIN
