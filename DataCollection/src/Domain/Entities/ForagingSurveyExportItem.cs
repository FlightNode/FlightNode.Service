...
namespace FlightNode.DataCollection.Domain.Entities
{
    ...
    /// </summary>
    public class ForagingSurveyExportItem : IEntity
    {
        /// <summary>
        ...
        /// </summary>
        public string NubmerOfJuveniles { get; set; }
        ...
        /// <summary>
        /// Gets or sets the feeding success rate
        /// </summary>
        public string FeedingSuccessRate { get; set; }

        /// <summary>
        /// Gets or sets the habitat type
        /// </summary>
